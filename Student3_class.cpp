...
class student{
    ...
    int roll,sem;
    public:
 student(int roll=0,int sem=0,int sec=0,const string n="default"){ // this *n is pointing an array it can also be written as char n[] actually an array is being passed form main thats why it is wrote like this
    this->roll=roll;
    this->sem=sem;
    this->sec=sec;
    name=n;
